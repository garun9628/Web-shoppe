                  ...
                  {section.options.map((option, optionIdx) => (
                    <div key={option.value} className="flex items-center">
                      <input
                        ...
                        type="checkbox"
                        defaultChecked={option.checked}
                        // TODO: doubt: when to pass function name and when to pass function call as an attribute. And why results is shown unexpectedly when function call is passed as an attribute on onClick event.
